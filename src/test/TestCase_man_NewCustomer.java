...
//	 static final int timec = 1;
	 ...
	 //错误信息
		...
		{ map.put("1","can not open url");
		  ...
		  map.put("13","can not select shipping method");
		  map.put("14","can not select fapiao");
		  map.put("15","can not check out");
		  map.put("16","can not select payment");		  	  
		}		
...
////	 @Parameters({ "url","useradd","userpassword" })
	 ...
	 public void TestNewCustomer() throws Exception {
		 ...
		 String useradd="newcustomer"+Test_man_NewCustomer.getrandomletter()+Test_man_NewCustomer.getrandomnum()+"@dec.com";
