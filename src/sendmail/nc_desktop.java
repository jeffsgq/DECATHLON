...
//		 driver.switchTo().defaultContent();
//		 driver.switchTo().frame("content");
//		 return Integer.valueOf(driver.findElement(By.xpath("/html/body/table/tbody/tr/td[2]/div")).getText());
//	}
//	
...
//		 driver.switchTo().defaultContent();
//		 driver.switchTo().frame("content");
//		 driver.findElement(By.xpath("/html/body/label[1]")).click();
//		 driver.findElement(By.xpath("/html/body/label[2]")).click();
//	}
}
