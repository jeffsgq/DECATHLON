...
public class nc_email {
	...
	// 收件人
	private static String to = "jeff.shi@decathlon.com";
//		"qinglan.xu@decathlon.com,"
//		+ "external.z52mxu@decathlon.com,"
//		+ "zhiqiang.ge@decathlon.com,"
//		+ "qinglan.xu@decathlon.com,"
//		+ "xiao.wang@decathlon.com,"
//		+ "qixin.huang@decathlon.com,"
//		+ "johnny.wang@decathlon.com,"
//		+ "ting.sun2@decathlon.com,"
//		+ "ruiheng.ruan@decathlon.com,"
//		+ "david.liu2@decathlon.com,"
//		+ "kenx.gao@decathlon.com";  //jeff.shi@decathlon.com,qinglan.xu@decathlon.com,zhiqiang.ge@decathlon.com,qinglan.xu@decathlon.com,xiao.wang@decathlon.com,qixin.huang@decathlon.com,johnny.wang@decathlon.com,ting.sun2@decathlon.com,ruiheng.ruan@decathlon.com,david.liu2@decathlon.com,kenx.gao@decathlon.com";
	...
	public static void realmail(String string, String string2, String string3, String string4, String string5, String string6, String string7, String string8) throws Exception {
		// 发送文本邮件
		// sendTextEmail();
		...
		sendHtmlWithInnerImageEmail(name1,name2,name3,name4,exception1,exception2,exception3,exception4);
	...
	public static void sendHtmlWithInnerImageEmail(String name1, String name2, String name3, String name4, String exception1, String exception2, String exception3, String exception4) throws MessagingException {
